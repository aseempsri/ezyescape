export const STAYS = [
  {
    ...
    directions:
      'Fly or train into Kathgodam, then drive ~3.5 hours via Bhowali–Almora. The last 4 km is a quiet hill road; a private transfer can be arranged from Kathgodam or Almora bus stand.',
    highlights: [
  ...
  },
  {
    ...
    hosts:
      'Your host lives a short walk away and checks in gently: fresh bread in the morning, a thermos of chai for your hike, and advice on which ridge catches the best sunset.',
    directions:
      'Reach Ranikhet by road from Kathgodam (~3 hours) or Almora (~1.5 hours). From Ranikhet bazaar, follow signs toward Chaubatia; the cottage is 20 minutes up a forest lane.',
    highlights: [
  ...
  },
  {
    ...
    story:
      'Wide rooms, a lawn for kids to run, and a kitchen that never seems empty — this is the stay parents recommend to each other. You are close enough to Nainital for day trips, far enough that evenings feel like the hills again.',
    hosts:
    ...
    directions:
      'From Kathgodam, drive ~1.5 hours toward Nainital; the home is 25 minutes before the main lake road, on a paved village approach.',
    highlights: [
  ...
  },
  {
    ...
    story:
      'Kausani is famous for its horizon of snow peaks, and this cottage faces that stretch of sky. Reliable enough connectivity for focused remote work, soft enough evenings that you will still feel like you escaped.',
    hosts:
      'The hosts keep the cottage stocked simply — fresh eggs, local honey, and a bookshelf that rewards slow reading.',
    directions:
      'From Kathgodam, drive ~5–6 hours via Almora–Kausani. The cottage is 10 minutes from Kausani bazaar on a motorable road.',
    highlights: [
